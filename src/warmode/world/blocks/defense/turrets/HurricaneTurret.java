...
public class HurricaneTurret extends ItemTurret {
  public float shiftRotation = 0;
  public HurricaneTurret(String name){
    super(name);
    shootCone = 360;
    recoilAmount = 0;
    inaccuracy = 0;
  ...
  public class HurricaneTurretBuild extends ItemTurret.ItemTurretBuild{
    ...
    protected void shoot(BulletType type){
      ...
      if(chargeTime > 0){
        ...
        for(int i = 1; i <= shots; i++){
          tr.trns(spread * i + rotation + shiftRotation, (Mathf.sin(45) * (size * tilesize / 2f)));
